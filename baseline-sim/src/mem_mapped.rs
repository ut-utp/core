    ...
    ($pin:expr, $pin_name:literal, $cr:ident, $dr:ident, $cr_addr:expr, $dr_addr:expr) => {
        ...
        impl MemMapped for $cr {
                ...
                <I as Deref>::Target: Peripherals<'a>,
            {
                ...
                Pwm::set_state(interp.get_peripherals_mut(), $pin, state).unwrap(); // TODO: do something different on error? (as of 4/7/2020 this should not fail?)
        ...
        impl MemMapped for $dr {
                ...
                <I as Deref>::Target: Peripherals<'a>,
            {
                ...
                Pwm::set_duty_cycle(interp.get_peripherals_mut(), $pin, duty_val); // TODO: do something on failure (as of 4/7/2020 this should not fail?)
